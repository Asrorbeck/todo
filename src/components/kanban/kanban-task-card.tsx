...
export function KanbanTaskCard({ task, onDragStart, isDragging }: any) {
  ...
  return (
    <>
      <Card
        ...
        className={`p-4 cursor-pointer hover:shadow-md transition-all bg-card group border-l-4 ${
      ...
      >
        ...
        {task.dueDate && (
          <div className={`text-xs ${isOverdue ? "text-destructive font-semibold" : "text-muted-foreground"}`}>
